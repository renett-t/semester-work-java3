...
public interface UserDataValidatorInterface {
    ...
    boolean arePasswordsCorrect(String password, String repeatedPassword);
    ...
    boolean isUserParametersCorrect(String firstName, String secondName, String email, String login);
}
